...
not_run: WebUI.click(findTestObject('Object Repository/Page_ICRC Application/label_If Other please indicate'))

not_run: WebUI.click(findTestObject('Object Repository/Page_ICRC Application/div_Other (please specify belo'))

WebUI.click(findTestObject('Page_ICRC Application/input_other_scientificMetho'))

WebUI.setText(findTestObject('Page_ICRC Application/input_textfield_If Other please indicate'), 'Testing')
