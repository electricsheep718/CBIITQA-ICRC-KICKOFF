...
WebUI.setText(findTestObject('Object Repository/Page_Registration/input__password (1)'), Password)

WebUI.setText(findTestObject('Object Repository/Page_Registration/input__confirmPassword (1)'), ConfirmPassword)
