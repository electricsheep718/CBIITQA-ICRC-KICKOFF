...
WebUI.setText(findTestObject('Object Repository/Page_Registration/input__firstName (1)'), 'FirstName_1')

WebUI.setText(findTestObject('Object Repository/Page_Registration/input_Middle Name_middleName (1)'), 'Middle_1')

WebUI.setText(findTestObject('Object Repository/Page_Registration/input__lastName (1)'), 'LastName_1')

WebUI.setText(findTestObject('Object Repository/Page_Registration/input__email (1)'), 'firstname1@nih.edu')
